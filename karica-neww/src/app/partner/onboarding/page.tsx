            ...
            <div className="mx-auto max-w-2xl">
                ...
                <div className="mb-8 text-center">
                    <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center">
                        <img src={karicaLogo.src} alt="Karica" className="h-16 w-16 object-contain" />
                    </div>
                    ...
                    <div className="flex justify-between">
                        {steps.map((step) => {
                            ...
                            return (
                                <div
                                    key={step.id}
                                    className={`flex flex-col items-center gap-2 ${isActive ? 'text-primary' : isCompleted ? 'text-primary/70' : 'text-muted-foreground'
                                        }`}
                                >
                                    <div
